...
# 2. Write the Streamlit script
import streamlit as st
import pandas as pd
import pickle
from datetime import datetime, timedelta

# Set the page configuration with a wide layout and new background color
st.set_page_config(
...
# Apply custom CSS styles to control image sizes and layout
st.markdown("""
    <style>
    /* Custom fonts */
...
# Add the containerized title above the image
...
# Create a styled container for the inputs with updated color scheme
...
# Subcategory selection dropdown with tooltip and bold label
subcategory_mapping = {
    'ADULT CEREAL': 0,
    'FAMILY CEREAL': 1,
    'KIDS CEREAL': 2,
...
# Center the button using custom styling
